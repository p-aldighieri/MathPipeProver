...
Given the proof breakdown and any previous proof attempts/reviews, advance the proof by proving lemmas and connecting them. You work one cycle at a time, building on prior work.

## Instructions

1. **Identify what needs to be proven next** based on the breakdown and previous cycles.
...
- **One cycle, focused progress**: aim to prove 1-3 lemmas per cycle rather than rushing through everything superficially.
