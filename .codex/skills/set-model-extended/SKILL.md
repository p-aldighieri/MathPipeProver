...
description: Verify or set the ChatGPT composer to the Pro target (GPT-6, top Power level; pill reads "6 Pro"; legacy name "Extended Pro"). Required before any analytical submission.
---
...
the script will actively select the `Latest` model family and the top
`Power` level, and auto-disable Deep Research if it's currently active.
