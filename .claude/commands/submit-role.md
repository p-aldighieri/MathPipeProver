...
Recovery: If the response seems truncated or the page errors, save whatever was captured
and report the chat URL so the user can manually inspect or use `/recover-chat`.
