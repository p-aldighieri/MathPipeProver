#!/usr/bin/env bash
# scripts/council/dispatch_extended_pro.sh — Run the ChatGPT Pro council member
# (GPT-6 Pro; legacy filename kept). Submits via the lib-backed browser flow,
# which enforces the Pro target (see CLAUDE.md §Model Configuration).
#
